...
const Home = () => {
  return (
    <section className="h-full bg-[#0B0C10] mt-[-80px]"> {/* подняли секцию еще выше */}
      <div className="container mx-auto h-full">
        <div className="flex flex-col justify-center min-h-[70vh] py-2"> {/* еще уменьшили min-h и py */}
          {/* text */}
          <div className="text-center max-w-[900px] mx-auto -mt-16"> {/* еще больше подняли блок с текстом */}
            ...
            <p className="text-[#F5F5F5]/80 mb-6 text-xl md:text-2xl leading-relaxed max-w-[700px] mx-auto"> {/* еще уменьшили mb */}
      ...
      {/* Stats section */}
      <div className="bg-[#0B0C10]/90 mt-[-120px]"> {/* еще выше подняли секцию Stats */}
        <Stats />
      </div>
    </section>
  )
